...
class StatusUpdatesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create status_update" do
    assert_difference('StatusUpdate.count') do
      post status_updates_url, params: { status_update: { add_status: @status_update.add_status, remarks: @status_update.remarks } }
    end
  ...
  test "should update status_update" do
    patch status_update_url(@status_update), params: { status_update: { add_status: @status_update.add_status, remarks: @status_update.remarks } }
