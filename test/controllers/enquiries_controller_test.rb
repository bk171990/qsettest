...
class EnquiriesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create enquiry" do
    assert_difference('Enquiry.count') do
      post enquiries_url, params: { enquiry: { alternate_contact_no: @enquiry.alternate_contact_no, center_id: @enquiry.center_id, contact_no: @enquiry.contact_no, email: @enquiry.email, full_name: @enquiry.full_name } }
    end
  ...
  test "should update enquiry" do
    patch enquiry_url(@enquiry), params: { enquiry: { alternate_contact_no: @enquiry.alternate_contact_no, center_id: @enquiry.center_id, contact_no: @enquiry.contact_no, email: @enquiry.email, full_name: @enquiry.full_name } }
